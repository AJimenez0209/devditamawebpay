            ...
            <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg border">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input className="input" name="name" placeholder="Nombre del Producto" value={product.name} onChange={handleChange} required />

                        <input className="input" name="image" placeholder="URL de Imagen Principal" value={product.image} onChange={handleChange} required />
                    </div>
                    ...
                    <textarea className="input mt-4" name="description" placeholder="Descripción detallada" value={product.description} onChange={handleChange} required />
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg border">
                    ...
                    <label className="flex items-center gap-2 mt-4">
                        ...
                        <span className="text-sm text-gray-700">Producto destacado en tienda</span>
                    </label>
                </div>

                {/* Tallas y Stock */}
                <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Precios, Unidades y Stock por Tamaño</h2>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {SIZES.map((size) => (
                            <div key={size} className="border p-4 rounded-lg shadow-sm bg-gray-50">
                                <h3 className="font-semibold mb-4 text-blue-600 text-center">{size}</h3>

                                <div className="space-y-2">
                                    <div>
                                        <label className="text-sm text-gray-600">Precio Unitario (CLP)</label>
                                        <input
                                    ...
                                    <div>
                                        <label className="text-sm text-gray-600">Unidades por Pack</label>
                                        <input
                                            className="input mt-1"
                                            type="number"
                                            name={`unitsPerPack.${size}`}
                                            placeholder="Ej: 36"
                ...
                {/* Botón Final */}
                <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white text-lg w-full py-3 rounded-xl shadow-md transition">
